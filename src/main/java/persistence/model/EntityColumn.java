...
public class EntityColumn {
    ...
    public static EntityColumn build(Field field) {
        return build(field, Optional.empty());
    }

    public static EntityColumn build(Field field, Object entityObject) {
        Value value = Value.create(entityObject, field);
        return build(field, Optional.of(value));
    }

    private static EntityColumn build(Field field, Optional<Value> value) {
