...
public class QueryBuilderDDL<T> {
    ...
    public String create() {
        return new StringBuilder(format(DEFAULT_CREATE_TABLE_FORMAT, createTableName()))
                .append(format(DEFAULT_CREATE_TABLE_COLUMNS_FORMAT,
    ...
    private String createPrimaryKeyConstantsQuery(List<EntityColumn> columns) {
        return format(DEFAULT_CREATE_TABLE_PRIMARY_KEY_FORMAT,
                columns.stream()
    ...
    public String drop() {
        return format(DEFAULT_DROP_TABLE_FORMAT, createTableName());
    }
}
