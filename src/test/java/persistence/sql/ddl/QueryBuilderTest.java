...
class QueryBuilderTest {
    ...
    void persion_ddl_create2() {
        ...
        String expectedDDL = "create table person (id bigint generated by default as identity, old integer, email varchar(255) not null, nick_name varchar(255), primary key (id))";
