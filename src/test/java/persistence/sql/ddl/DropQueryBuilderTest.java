    ...
    class DropQuery {
        ...
        void noEntity() {
            assertThatExceptionOfType(NoEntityException.class)
                    .isThrownBy(() -> new DropQueryBuilder<>(NoHasEntity.class).drop());
        }
        ...
        void noTable() {
            //given
            DropQueryBuilder<PkHasPerson> ddl = new DropQueryBuilder<>(PkHasPerson.class);
        ...
        void hasTable() {
            //given
            DropQueryBuilder<Person> ddl = new DropQueryBuilder<>(Person.class);
