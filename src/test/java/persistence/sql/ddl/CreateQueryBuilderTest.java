...
public class CreateQueryBuilderTest {
    ...
    public void shouldCreateCreateTableQuery() {
        ...
        String expectedQuery = "CREATE TABLE users (id BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY, nick_name VARCHAR(255), old INTEGER, email VARCHAR(255) NOT NULL, PRIMARY KEY (id));";
