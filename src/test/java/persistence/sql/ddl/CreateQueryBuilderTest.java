...
class CreateQueryBuilderTest {
    ...
    void canCreateDDLFromEntityAnnotatedClass() {
        final CreateQueryBuilder builder = new CreateQueryBuilder(Person.class);
    ...
    void canNotCreateQueryBuilderFromNonEntityAnnotatedClass() {
        assertThatThrownBy(() -> new CreateQueryBuilder(int.class))
    ...
    void canCreateDDLUsingIdGenerationStrategyAndColumnConstraints() {
        final CreateQueryBuilder builder = new CreateQueryBuilder(PersonWithCustomColumnName.class);
        final String expected = String.join(System.lineSeparator(),
    ...
    void canCreateDDLUsingCustomTableNameAndTransientField() {
        final CreateQueryBuilder builder = new CreateQueryBuilder(PersonWithCustomTableNameAndTransientColumn.class);
        final String expected = String.join(System.lineSeparator(),
                "CREATE TABLE users (",
                "id BIGINT PRIMARY KEY AUTO_INCREMENT,",
                "nick_name VARCHAR,",
