...
class CreateQueryBuilderTest {
    ...
    void test_bulidQuery() {
        String query = createQueryBuilder.buildQuery(Person.class);
        assertEquals(query, "CREATE TABLE users(id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, nick_name VARCHAR(255), old INTEGER, email VARCHAR(255) NOT NULL);");
    }
