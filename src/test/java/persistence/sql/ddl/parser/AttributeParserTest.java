    ...
    class pareIdAttribute {
        ...
        class withClass {
            ...
            void returnIdAttribute() {
                ...
                assertThat(idAttribute.makeComponent()).isEqualTo("id BIGINT GENERATED BY DEFAULT AS IDENTITY");
            }
        }
    }
        ...
        class withClass {
            ...
            void returnGeneralAttributes() {
                ...
                Assertions.assertAll(
                        ...
                        () -> assertThat(generalAttributeList.get(0).makeComponent()).isEqualTo("name VARCHAR(200)"),
                        () -> assertThat(generalAttributeList.get(1).makeComponent()).isEqualTo("old INTEGER NOT NULL")
                );
            }
        }
    }
