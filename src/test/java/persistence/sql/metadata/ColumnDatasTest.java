...
class ColumnDatasTest {
    ...
    void getColumnNames() {
        ...
        ColumnDatas columnDatas = new ColumnDatas(datas);

        assertThat(columnDatas.getColumnNames()).containsExactly("id", "name");
    }
    ...
    void getColumnValues() {
        ...
        assertThat(columnDatas.getColumnValues()).containsExactly("1", "'name'");
    }
    ...
    void getAll() {
        ...
        assertThat(columnDatas.getAll()).containsExactlyElementsOf(datas);
    }
}
