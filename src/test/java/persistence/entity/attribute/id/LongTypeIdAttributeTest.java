...
class LongTypeIdAttributeTest {
        ...
        class withValidArgs {
            ...
            void of() throws NoSuchFieldException {
                ...
                Assertions.assertAll(
                        () -> assertThat(longTypeIdAttribute).isEqualTo("id"),
                        () -> assertThat(longTypeIdAttribute).isEqualTo(GenerationType.IDENTITY),
                        () -> assertThat(longTypeIdAttribute).isEqualTo("id")
                );
            }
        }
    ...
    class prepareDDL {
        ...
        void prepareDDL() throws NoSuchFieldException {
            ...
            LongTypeIdAttribute longTypeIdAttribute = LongTypeIdAttribute.of(field);
            longTypeIdAttribute.prepareDDL(new H2SqlConverter());
            assertThat(longTypeIdAttribute.prepareDDL(new H2SqlConverter())).isEqualTo("id BIGINT GENERATED BY DEFAULT AS IDENTITY");
        }
    }
}
